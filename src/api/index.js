...
app.post("/auth/login", async (req, res) => {
  ...
  try {
    ...
    if (!user) {
      console.log("LOGIN ERROR: user not found in DB");
...
const test = async () => {
  ...
  const hash = '$2b$10$7zWKHMk9hC5eJtVDo4TUYufCzqJTXHWMQtbgTzSS0zDFOp5oc/2.G';
  console.log(await bcrypt.compare(password, hash)); // має бути true
};
test();
export default app;
